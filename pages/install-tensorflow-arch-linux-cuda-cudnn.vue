<template>
  ...
  >
    <BlogTitle
      title="Installing TensorFlow for Python on Arch Linux (with CUDA 9 and CUDNN 7)"
    ...
    <div class="content" itemprop="articleBody" v-highlight>
      <ol>
        <li>
          ...
          ><code class="prefix">yaourt -S gcc6</code></pre>
        </li>
        ...
        <li>
          ...
          <pre
            class="language-bash command-line"
          ><code class="prefix">sudo pacman -R cuda</code>
<code class="prefix">pacaur -S chromedriver</code></pre>
        ...
        <li>
          ...
          <pre
            class="language-bash command-line"
          ><code class="prefix">wget https://archive.archlinux.org/packages/c/cuda/cuda-9.0.176-4-x86_64.pkg.tar.xz</code></pre>
        </li>
        ...
        <li>
          ...
          <pre
            class="language-bash command-line"
          ><code class="prefix">sudo pacman -U cuda-9.0.176-4-x86_64.pkg.tar.xz</code></pre>
        </li>
        ...
        <li>
          ...
          <pre
            class="language-bash command-line"
          ><code class="prefix">sudo vim /etc/pacman.conf</code></pre>
        ...
        <li>
          ...
          <pre
            class="language-bash command-line"
          ><code class="prefix">https://archive.archlinux.org/packages/c/cudnn/cudnn-7.1.4-1-x86_64.pkg.tar.xz</code>
<code class="prefix">sudo pacman -U cudnn-7.1.4-1-x86_64.pkg.tar.xz</code></pre>
        ...
        <li>
          ...
          <pre
            class="language-bash command-line"
          ><code class="prefix">pip install tensorflow-gpu</code></pre>
        </li>
