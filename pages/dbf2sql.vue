<template>
    <article itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
        ...
        <div class="content" itemprop="articleBody" v-highlight>
            ...
            <div class="block">
                <pre class="language-bash command-line"><code class="prefix">php dbf2sql.php input.dbf tablename output.sql</code></pre>
            ...
            <p>
                Only the input file argument is mandatory. The script is able to predict the table name and the output filename.</p>
            <h4>Examples:</h4>

            <div class="block">
                <pre class="language-bash command-line"><code class="prefix">php dbf2sql.php input.dbf myData</code></pre>
                <div>Since output file name isn’t given, <code>myData.sql</code> will be generated.</div>
            </div>

            <div class="block">
                <pre class="language-bash command-line"><code class="prefix">php dbf2sql.php data.dbf</code></pre>
                <div>This will create <code>data.sql</code> script that would create a table named <code>data</code>
                </div>
            </div>

            <div class="block">
                <pre class="language-bash command-line"><code class="prefix">php dbf2sql.php --bulk</code></pre>
                OR
                <pre class="language-bash command-line"><code class="prefix">php dbf2sql.php --all</code></pre>
