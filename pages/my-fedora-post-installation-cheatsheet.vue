  ...
  >
    ...
    <div class="content" itemprop="articleBody" v-highlight>
      ...
      <pre
        ...
        data-prompt="#"
      ><code>yum -y localinstall --nogpgcheck http://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-stable.noarch.rpm http://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-stable.noarch.rpm</code></pre>
...
chmod +x /etc/sysconfig/modules/b43.modules
      ...
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install gnome-tweak-tool dconf-editor gconf-editor</code></pre>
      <h3>Install guake terminal</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install guake</code></pre>
      <p>
      ...
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install gstreamer gstreamer-ffmpeg gstreamer-plugins-bad gstreamer-plugins-bad-free gstreamer-plugins-bad-nonfree gstreamer-plugins-base gstreamer-plugins-good gstreamer-plugins-ugly ffmpeg xmms xmms-mp3 xine xine-lib</code></pre>

      <h3>Clementine media player</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install clementine</code></pre>
      <h3>VLC media player</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install vlc</code></pre>
      <h3>SMPlayer</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install smplayer</code></pre>
      <h3>Image Editors</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install gimp inkscape</code></pre>
      <h2>Utilities:</h2>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install wget</code></pre>
      <h3>System monitoring tools</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install lm_sensors hddtemp</code></pre>
      <h3>Install Artha, the dictionary</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install artha</code></pre>
      <h3>Install English language pack for Libreoffice.</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install libreoffice-langpack-en</code></pre>
      <h3>
      ...
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install p7zip p7zip-plugins unrar</code></pre>
      <h3>Install android-tools (provides adb and fastboot)</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install android-tools</code></pre>
      <h3>
      ...
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install nemo nemo-fileroller
xdg-mime default nemo.desktop inode/directory application/x-gnome-saved-search</code></pre>
      ...
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install firefox</code></pre>
      <h3>Install flash plugin for browsers:</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install lpf-flash-plugin</code></pre>
      And then launch
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>lpf-flash-plugin</code></pre>
      <h3>Install Skype:</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install lpf-skype</code></pre>
      And then launch
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>lpf-skype</code></pre>

      <h2>For developers:</h2>
      <pre class="language-bash command-line" data-prompt="#">
        <code>yum -y install vim git gitg hg
yum -y install gcc zlib-devel libjpeg-devel</code></pre>
      ...
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install filezilla</code></pre>
      <h3>Install OpenJDK</h3>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>yum -y install java-*-openjdk java-*-openjdk-plugin</code></pre>
      <h3>Apache and PHP</h3>
      <pre class="language-bash command-line" data-prompt="#"><code>yum -y install httpd php php-xml
schkconfig httpd on
rm -rf /etc/httpd/conf.d/welcome.conf
find /var/www/html -type d -print | xargs chmod g+rwxs</code></pre>
      <h4>Enable directives in .htaccess</h4>
      <pre
        class="language-bash command-line"
        data-prompt="#"
      ><code>vi /etc/httpd/conf/httpd.conf</code></pre>
      ...
      <h3>MySQL</h3>
      <pre class="language-bash command-line" data-prompt="#">
        <code>yum -y install mysql mysql-server phpmyadmin
chkconfig mysqld on
service mysqld restart
mysql_secure_installation</code></pre>
      <h3>Python:</h3>
      <pre class="language-bash command-line" data-prompt="#"><code>wget https://raw.github.com/pypa/pip/master/contrib/get-pip.py
python get-pip.py
pip install virtualenv
yum -y install python-devel</code></pre>

      <h3>Postgres:</h3>

      <pre class="language-bash command-line" data-prompt="#">
<code>yum -y install postgresql-server
...
systemctl enable postgresql.service</code></pre>
      ...
      with git.)
      <pre class="language-bash command-line" data-prompt="$"><code>sudo yum -y install ruby
...
source ~/.bashrc # or source ~/.zshrc</code></pre>
      ...
      <pre
        class="language-bash command-line"
        data-prompt="$"
      ><code>yum install gnome-shell-extension-gpaste</code></pre>
    </div>
  </article>
</template>
