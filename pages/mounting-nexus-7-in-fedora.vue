<template>
  ...
  >
    <BlogTitle
      title="Mounting Nexus 7 in Fedora"
    ...
    <div class="content" itemprop="articleBody" v-highlight>
      ...
      <p>
        Install simple-mtpfs:<br />
        <pre class="language-bash command-line"><code class="su">yum install simple-mtpfs</code></pre>
      </p>
      <p>
        Create a mount point:<br />
        <pre class="language-bash command-line"><code class="su">mkdir -p /media/n7</code></pre>
      </p>
      <p>
        Mount the tablet:<br />
        <pre class="language-bash command-line"><code class="su">simple-mtpfs /media/n7</code></pre>
      </p>
      <p>
        To Unmount:<br />
        <pre class="language-bash command-line"><code class="su">fusermount -u /media/n7</code></pre>
      </p>
      <p>
