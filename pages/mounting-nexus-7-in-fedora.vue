  ...
  >
    ...
    <div class="content" itemprop="articleBody">
      ...
      <p>
        ...
        <pre class="language-bash"><code class="su">yum install simple-mtpfs</code></pre>
      </p>
      <p>
        Create a mount point:<br />
        <pre class="language-bash"><code class="su">mkdir -p /media/n7</code></pre>
      </p>
      <p>
        Mount the tablet:<br />
        <pre class="language-bash"><code class="su">simple-mtpfs /media/n7</code></pre>
      </p>
      <p>
        To Unmount:<br />
        <pre class="language-bash"><code class="su">fusermount -u /media/n7</code></pre>
      </p>
      <p>
