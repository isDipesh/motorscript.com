  ...
  >
    ...
    <div class="content" itemprop="articleBody">
      ...
      <p>
        ...
        buckets from https://s3.console.aws.amazon.com/s3/buckets/. Amazon's
        help page on creating a new bucket -
...
<code class="prefix">sudo pip3 install 'wal-e[aws]'</code></pre>
      ...
      <pre
        class="language-bash"
      ><code class="prefix">sudo mkdir -p /etc/wal-e.d/env</code>
...
<code class="prefix">echo -e "archive_timeout = 60" | sudo tee -a /etc/postgresql/${POSTGRES_VERSION}/main/postgresql.conf</code></pre>
      ...
      <pre
        class="language-bash"
      ><code class="prefix">crontab -l | { cat; echo "0 0 * * * /usr/bin/envdir /etc/wal-e.d/env /usr/local/bin/wal-e backup-push /var/lib/postgresql/{{version}}/main"; } | crontab -</code></pre>
